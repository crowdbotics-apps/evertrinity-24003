"""evertrinity_24003 URL Configuration
...
admin.site.site_header = "Evertrinity"
admin.site.site_title = "Evertrinity Admin Portal"
admin.site.index_title = "Evertrinity Admin"

# swagger
api_info = openapi.Info(
    title="Evertrinity API",
    default_version="v1",
    description="API documentation for Evertrinity App",
)
